...
set CLASSPATH=%APP_HOME%\lib\Server-1.0-SNAPSHOT.jar;%APP_HOME%\lib\postgresql.jar;%APP_HOME%\lib\Other-1.0-SNAPSHOT.jar;%APP_HOME%\lib\kotlin-stdlib-2.1.0.jar;%APP_HOME%\lib\annotations-13.0.jar


@rem Execute Server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" ServerMain %*
