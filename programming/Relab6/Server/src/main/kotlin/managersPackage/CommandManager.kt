...
import commandsPackage.GetClientCommands
import commandsPackage.GetServerCommand
...
object CommandManager{
    ...
    fun getCommand(list: List<String>, state: ClientState){
        ...
        if (command in CommandRegistry.specialCommands){
            CommandRegistry.specialCommands[command]?.execute()
        }
        else if (command in CommandRegistry.commands) {
